...
namespace AppMvc.Net.Areas.Blog.Controllers
{
    ...
    public class ViewPostController : Controller
    {
        ...
        public IActionResult Index(string categoryslug, [FromQuery(Name = "p")]int currentPage, int pagesize,IFormCollection? form)
        {
            ...
            {
                posts = posts.Where(x=>x.Title.Contains(form["searchblog"]));
            }
        ...
        // [Route("/post/{abc?}")]
        // public IActionResult Search(string categoryslug, [FromQuery(Name = "p")]int currentPage, int pagesize,IFormCollection? form)
        // {
        //     var categories = GetCategories();
        //     ViewBag.categories = categories;
        //     ViewBag.categoryslug = categoryslug;
